./fasttext supervised -input "data/20newsgroup.train" -output "result_fastText/20newsgroup" -dim 10 -lr 0.1 -wordNgrams 2 -minCount 1 -bucket 10000000 -epoch 640 -thread 4

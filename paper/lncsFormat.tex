...
\author{Weijing Huang\inst{1} \and Wei Chen\inst{1} \thanks{Corresponding author.} \and Yazhou Wang\inst{1} \and Tengjiao Wang\inst{1}}
...
Group ID& \#words*  & words  & NPMI & \#group* & Group ID& words & NPMI \\ \hline

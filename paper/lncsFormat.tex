...
\author{Weijing Huang\inst{1} \and Wei Chen\inst{1} \thanks{Corresponding author.}\and Tengjiao Wang\inst{1}}
...
%TODO 这个table需要增加BTM生成的和aviation最相近的一个topic的情况。
...
\hline
\multicolumn{4}{|c!{\vrule width 1pt}}{TransDetector} & \multicolumn{4}{c|}{LightLDA}    \\ \hline
\#group*  & \#words*  & words  & NPMI & \#group* & \#words* & words & NPMI \\ \hline
0 & 6-10 & airlines aviation flying pilot squadron &  0.113 & 0 & 6-10 & & \\ \hline
1 & 11-15 &flights pilots raf airways fighter & 0.155 & 1 & 11-15 & & \\ \hline
2 & 16-20 &boeing runway force crashed flew   & 0.092 & 2 & 16-20 & & \\ \hline
3 & 21-25 &airfield landing passengers plane aerial & 0.179 & 3 & 21-25 & & \\ \hline
4 & 26-30 &bomber radar wing bombers crash & 0.137 & 4 & 26-30 & & \\ \hline
5 & 31-35 &airbus airports operations jet helicopter & 0.189 & 5 & 31-35 & & \\ \hline
6 & 36-40 &squadrons base flown havilland crew & 0.088 & 6 & 36-40 & & \\ \hline
7 & 41-45 &combat luftwaffe aerodrome carrier fokker & 0.159 & 7 & 41-45 & & \\ \hline
8 & 46-50 &planes fly engine takeoff fleet & 0.186 & 8 & 46-50 & & \\ \hline
9 & 51-55 &fuselage helicopters aviator naval aero & 0.157 & 9 & 51-55 & & \\ \hline
10 & 56-60 &glider command training balloon faa & 0.166 & 10 & 56-60 & & \\ \hline
\(\cdots\) & \(\cdots\) &\(\cdots\) &\(\cdots\) & \(\cdots\) & \(\cdots\) &\(\cdots\) &\(\cdots\)\\ \hline
18 & 96-100 &scheduled carriers military curtiss biplane &0.131 & 11 & 96-100 & & \\ \hline
19 & 101-105 &accident engines iaf albatross rcaf &0.068 & 12 & 101-105 & & \\ \hline
\end{tabular}
}
\label{tbl:NPMIDetails}
\end{table}

%TODO figure2需要增加BTM的情况，以及要用盒形图表示
\hlgreen{Add a topic of BTM for Figure 2.}
\begin{figure}
        \centering
...
%TODO LSH-FSD\cite{Petrovic:2010uj}没有评测FSD的情况，我们也可以提一句，我们不评测FSD，我们只评测检测出的事件是否是真实的事件。
\hlgreen{TODO: check the number of detected events.}
\begin{table}[h]
\setlength{\abovecaptionskip}{0.cm}%set the distance between caption and table to 0 cm.
\setlength{\belowcaptionskip}{0.cm}
\centering
...
\scalebox{0.95}{
    ...
    \hline
    Method & \begin{tabular}[c]{@{}l@{}}Recall@ \\ Benchmark1\end{tabular} & \begin{tabular}[c]{@{}l@{}}Precision@ \\ Benchmark2\end{tabular} & \begin{tabular}[c]{@{}l@{}}Recall@ \\ Benchmark2\end{tabular} & \begin{tabular}[c]{@{}l@{}}F@ \\ Benchmark2\end{tabular} & \begin{tabular}[c]{@{}l@{}}DERate\\(Duplicate \\ Event Rate)\end{tabular} \\ \hline
    ...
    \textsc{TransDetector} & 1.000 & 0.894 & 0.950 & - & 0.042 \\ \hline
    \end{tabular}
}
\end{table}
...
\begin{tabular}{|c|l|l|c|l|l|l|l|l|l|}
\hline
...
7/22/11 & \begin{tabular}[c]{@{}l@{}}Norway, Oslo,\\ attacks, bombing\end{tabular} & \begin{tabular}[c]{@{}l@{}}Terror Attacks Devastate Norway: A bomb ripped through \\ government offices in Oslo and a gunman... http://dlvr.it/cLbk8\end{tabular} & 557 & \checkmark &  &  &  &  &  \\ \hline

...
\begin{frame}
\frametitle{\textsc{TransDetector}: Phase 1 (Extracting Category-Level Topics in KB)}	
...
%page 10
\begin{frame}
\frametitle{\textsc{TransDetector}: Phase 2 (Transferring Category-Level Info into Microblog Stream) (2/3)}	
...
\begin{frame}
\frametitle{\textsc{TransDetector}: Phase 2 (Transferring Category-Level Info into Microblog Stream) (3/3)}	
...
Evaluation on Categroy-Level Topics in Knowledge Base. On \textit{Aviation} topic, semantic coherence is much better than LightLDA (same as LDA) in terms of NPMI[Röder, WSDM 2015]. 
...
On more topics, semantic coherence is much better than LightLDA (same as LDA) in terms of NPMI[Röder, WSDM 2015]. 
\begin{figure}[h]
	\setlength{\abovecaptionskip}{0.cm}
	\setlength{\belowcaptionskip}{0.cm}
        \centering

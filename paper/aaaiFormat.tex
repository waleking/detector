...
(1) We formalize the knowledge base's hierarchical structure into three parts including taxonomy graph, category-page bipartite graph, and page-content map; and further shrink the scale of knowledge to category-word level.
The structure is utilized to condense category's highly related words and their chi-square scores, namely category's \textit{KB State}.
...
(3) Events are further detected on meaningful categories' \textit{Stream States}, which filter out the noisy accurately. 

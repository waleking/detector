...
%
\title{Lightweight Transfer Learning from Knowledge Base to Text Stream for High Accurate Event Detection}
\maketitle
...
Firstly, we demonstrate the effectiveness of history states  initialized from knowledge base and recent states learned by transfer learning. 

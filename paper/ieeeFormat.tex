...
%主动感知的
\title{Is That Enough to Only Use the Recent Data to Detect Events?}
...
In big data era, event detection is a profound, popular, but still challenging task. 
...
\begin{table}
\begin{tabular}{|c|p{0.1\columnwidth}|p{0.55\columnwidth}|} \hline
